    ...
    if resultado is not None:
        ...
        with st.expander("O que foi feito na planilha"):
            st.markdown(
                ...
                - **Dinâmica** — tabela dinâmica **nativa do Excel**, agrupada por
                  *Empresa, Loc.negócios, Conta, Centro de lucro, Segmento* e *Texto*,
                  somando *Montante em moeda interna*, *PIS* e *COFINS*. Por ser uma
                  tabela dinâmica de verdade, é possível clicar nela e usar o painel
                  "Campos da Tabela Dinâmica" do Excel para reorganizar como quiser.
                """
            )
