...
3. **Dinâmica** — tabela-resumo agrupada por *Empresa, Loc.negócios, Conta,
   Centro de lucro, Segmento* e *Texto*, somando *Montante em moeda interna*,
   *PIS* e *COFINS* (equivalente a uma tabela dinâmica do Excel, construída com
   fórmulas `SOMASES`/`SUMIFS` para máxima compatibilidade entre versões do Excel).
